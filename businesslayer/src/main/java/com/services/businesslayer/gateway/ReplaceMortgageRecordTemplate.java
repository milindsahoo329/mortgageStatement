...
@Component
public class ReplaceMortgageRecordTemplate {

    private static final String address = "http://localhost:9001/replace";

    public Map replaceMortgagePostRequest(AddReplaceMortgageDto requestBody){
